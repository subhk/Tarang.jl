...
@testset "Analysis Tasks Module" begin
    ...
    @testset "Function Signatures" begin
        @testset "add_mean_task! exists" begin
            @test isdefined(Tarang, :add_mean_task!)
            @test hasmethod(Tarang.add_mean_task!, Tuple{Tarang.NetCDFFileHandler, Any})
        end

        @testset "add_slice_task! exists" begin
            @test isdefined(Tarang, :add_slice_task!)
            @test hasmethod(Tarang.add_slice_task!, Tuple{Tarang.NetCDFFileHandler, Any})
        end

        @testset "add_profile_task! exists" begin
            @test isdefined(Tarang, :add_profile_task!)
            @test hasmethod(Tarang.add_profile_task!, Tuple{Tarang.NetCDFFileHandler, Any})
        end
    end
