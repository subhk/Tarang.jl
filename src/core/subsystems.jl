...
# Solver configuration options (following Dedalus solvers.py:39-65)
...
Following Dedalus subsystems.py:107-150.
...
Following Dedalus subsystems.py:124-129.
"""
...
function Subsystem(solver, group::Tuple=SUBSYSTEM_GROUP)
    ...
    # Compute matrix group (following Dedalus subsystems.py:124-129)
...
Following Dedalus subsystems.py:34-53.
"""
...
Following Dedalus subsystems.py:213-220.
"""
...
Following Dedalus subsystems.py:222-231.
"""
...
Following Dedalus subsystems.py:234-296.
...
mutable struct Subproblem
    ...
    # Preconditioners (following Dedalus subsystems.py:560-563)
...
function Subproblem(solver, subsystems::Tuple{Vararg{Subsystem}}, group::Tuple=SUBSYSTEM_GROUP)
    ...
    # Build group dictionary (following Dedalus subsystems.py:257-261)
    group_dict = Dict{String, Any}()
...
Following Dedalus subsystems.py:494-495.
"""
...
Following Dedalus subsystems.py:476-478.
"""
...
Following Dedalus subsystems.py:55-70.
"""
...
Following Dedalus subsystems.py:72-81.
"""
...
Following Dedalus arithmetic.py:370-373.
"""
...
Following Dedalus subsystems.py:497-596.
"""
function build_matrices!(sp::Subproblem, names, solver)
    ...
    # Construct matrices (following Dedalus subsystems.py:512-537)
    ...
    # Valid modes (following Dedalus subsystems.py:539-548)
    ...
    # Check squareness (following Dedalus subsystems.py:551-552)
    ...
    # Build permutation matrices (following Dedalus subsystems.py:554-556)
    ...
    # Build preconditioners (following Dedalus subsystems.py:559-563)
    ...
    # Precondition matrices (following Dedalus subsystems.py:569-571)
    for (name, matrix) in matrices
        matrices[name] = sp.pre_left * matrix * sp.pre_right
    end

    # Store minimal CSR matrices (following Dedalus subsystems.py:573-575)
    ...
    # Store expanded matrices for IMEX if requested (following Dedalus subsystems.py:577-588)
...
Compute update rank for Woodbury formula.
Following Dedalus subsystems.py:591-595.
"""
...
Following Dedalus subsystems.py:614-675.
...
Following Dedalus subsystems.py:678-739.
...
Following Dedalus tools/array.py perm_matrix.
"""
...
Following Dedalus tools/array.py drop_empty_rows.
"""
...
Following Dedalus tools/array.py zeros_with_pattern.
"""
...
Following Dedalus tools/array.py expand_pattern.
"""
...
Following Dedalus tools/array.py apply_sparse.
"""
...
Following Dedalus subsystems.py:340-350.
"""
...
Following Dedalus subsystems.py:364-371.
"""
...
Following Dedalus arithmetic.py:418-444.
"""
...
Following Dedalus arithmetic.py:446-460.
"""
