...
at once for better MPI efficiency (following GROUP_TRANSPOSES pattern):
...
# ============================================================================
# Grouped Transposes (Following GROUP_TRANSPOSES)
# ============================================================================
#
...
Following GROUP_TRANSPOSES and SYNC_TRANSPOSES configuration.
"""
...
Following Transpose.increment_group pattern.
...
function group_transpose_z_to_y!(fields::Vector{<:TransposableField})
    ...
    # Optional synchronization before transpose (SYNC_TRANSPOSES)
