...
- **Optional GPU**: CUDA, ROCm/AMDGPU, or Metal drivers if you want GPU execution; Tarang auto-detects when packages are present.
...
add_dirichlet_bc!(problem, "u", "z", 0.0, 0.0)   # bottom
add_dirichlet_bc!(problem, "u", "z", 1.0, 0.0)   # top
