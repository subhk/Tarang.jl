...
Tarang.add_dirichlet_bc!(problem, "ux", "z", 1.0, 0.0)
Tarang.add_dirichlet_bc!(problem, "uz", "z", 0.0, 0.0)
Tarang.add_dirichlet_bc!(problem, "uz", "z", 1.0, 0.0)

# Fixed temperatures
Tarang.add_dirichlet_bc!(problem, "T", "z", 0.0, 1.0)  # Hot
Tarang.add_dirichlet_bc!(problem, "T", "z", 1.0, 0.0)  # Cold
```
