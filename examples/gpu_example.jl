...
println("  Grid data type: $(typeof(get_grid_data(u)))")
println("  Coefficient data type: $(typeof(get_coeff_data(u)))")
...
# When saving to NetCDF, data is automatically transferred from GPU to CPU
